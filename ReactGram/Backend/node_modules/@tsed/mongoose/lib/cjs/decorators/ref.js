 ...
 * @property
 */
function Ref(model, options = MongooseSchemaTypes_1.MongooseSchemaTypes.OBJECT_ID) {
    if (!model) {
    ...
    const getType = () => ((0, core_1.isString)(model) ? MongooseModels_1.MongooseModels.get(model) : (0, core_1.isArrowFn)(model) ? model() : model);
    const populatedGroups = ((0, core_1.isObject)(options) && options.populatedGroups) || [];
    return (0, core_1.useDecorators)((0, schema_1.Property)(Object), (0, core_1.StoreMerge)(constants_1.MONGOOSE_SCHEMA, {
        type: mongoose_1.Schema.Types[(0, core_1.isObject)(options) ? options.type || MongooseSchemaTypes_1.MongooseSchemaTypes.OBJECT_ID : options],
        ref: model
