...
function getRef(opts) {
    const ref = opts.ref;
    return (0, core_1.isString)(ref) ? ref : core_1.Store.from(ref).get(constants_1.MONGOOSE_MODEL_NAME);
}
function getType(opts) {
    const ref = opts.ref;
    return !(0, core_1.isString)(ref) ? ref : MongooseModels_1.MongooseModels.get(ref) || (() => MongooseModels_1.MongooseModels.get(ref) || Object);
}
...
function VirtualRef(options, foreignField) {
    ...
    return (0, core_1.useDecorators)((0, core_1.StoreMerge)(constants_1.MONGOOSE_SCHEMA, schema), schema.count ? (0, schema_1.Property)(Number) : type && (schema.justOne ? (0, schema_1.Property)(type) : (0, schema_1.CollectionOf)(type)));
}
