...
function getType(refPath, ctx) {
    return (ctx?.self[refPath] && MongooseModels_1.MongooseModels.get(ctx.self[refPath])) || Object;
}
/**
...
function DynamicRef(refPath, ...types) {
    return (0, core_1.useDecorators)((0, schema_1.Property)(Object), (0, schema_1.Example)("5ce7ad3028890bd71749d477"), (0, schema_1.Description)("A reference ObjectID"), (0, core_1.StoreMerge)(constants_1.MONGOOSE_SCHEMA, {
