...
function createSchema(target, options = {}) {
    ...
    const schemaOptionsFromStore = entity.store.get(constants_1.MONGOOSE_SCHEMA_OPTIONS) || {};
    ...
    (0, schemaOptions_1.schemaOptions)(target, options);
    ...
    core_1.Store.from(target).set(constants_1.MONGOOSE_SCHEMA, schema);
    return schema;
}
...
function buildMongooseSchema(target) {
    ...
    properties.forEach((propertyMetadata, key) => {
        ...
        if (schemaTypeOptions.ref) {
            schemaTypeOptions.ref = (0, resolveRefType_1.resolveRefType)(schemaTypeOptions.ref);
        }
