...
class JsonSchema extends Map {
    ...
    toJSON(options) {
        ...
        const schema = (0, JsonSchemaMapperContainer_1.execMapper)("schema", this, options);
     ...
     */
    getName() {
        return this.get("name") || (this.#target ? (0, core_1.nameOf)((0, core_1.classOf)(this.getComputedType())) : "");
    }
    clone() {
